    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 text-sm">Join EventHub and start collaborating</p>
        </div>

        <form onSubmit={signup} className="space-y-6">
          <div>
            <label className="block text-xs font-semibold text-slate-900 uppercase tracking-widest mb-2">Username</label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <IoPersonOutline className="text-slate-400 text-lg" />
              </div>
              <input
                name="username"
                type="text"
