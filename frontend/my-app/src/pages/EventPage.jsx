...
import { IoChatbubbleEllipsesSharp, IoCopyOutline } from "react-icons/io5";
              ...
              <div key={status} className="flex flex-col">
                ...
                <div className={`${config.headerColor} text-white px-4 py-3 rounded-t-xl shadow-md`}>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="bg-white bg-opacity-25 px-2.5 py-0.5 rounded-full text-sm font-semibold">
                      ...
                      {task.assignedTo && task.assignedTo._id === currentUserId && (
                        <div className="flex flex-wrap gap-2">
                          {status !== "todo" && (
                            <button
                              disabled={event.isFinished}
                              className="px-3 py-1.5 text-xs bg-slate-200 text-slate-700 rounded-lg hover:bg-slate-300 transition font-medium disabled:opacity-50"
                          ...
                          {status !== "in-progress" && (
                            <button
                              disabled={event.isFinished}
                              className="px-3 py-1.5 text-xs bg-amber-400 text-white rounded-lg hover:bg-amber-500 transition font-medium disabled:opacity-50"
                          ...
                          {status !== "completed" && (
                            <button
                              disabled={event.isFinished}
                              className="px-3 py-1.5 text-xs bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition font-medium disabled:opacity-50"
